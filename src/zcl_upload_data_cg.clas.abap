CLASS zcl_upload_data_cg DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_upload_data_cg IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    out->write( 'Starting data loading...' ).

    DATA: lt_acc_cat   TYPE TABLE OF ztb_acc_categ_CG,
          lt_catego    TYPE TABLE OF ztb_catego_CG,
          lt_clientes  TYPE TABLE OF ztb_clientes_CG,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_CG,
          lt_libros    TYPE TABLE OF ztb_libros_CG.

**********************************************************************
****************** TABLE 1: ZBT_ACC_CAT_CG *************************
**********************************************************************
    ...
    DELETE FROM ztb_acc_categ_CG.
    INSERT ztb_acc_categ_CG FROM TABLE @lt_acc_cat.
...
**********************************************************************
    ...
    DELETE FROM ztb_catego_CG.
    INSERT ztb_catego_CG FROM TABLE @lt_catego.
...
**********************************************************************
******************** TABLE 3: ZBT_CLIENTE_CG ***********************
**********************************************************************

    lt_clientes = VALUE #(
    ( id_cliente = '005638984K' tipo_acceso = '1' nombre = 'Andrew' apellidos = 'Roberts' email = 'STEPHANIE.ROBERTS@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '049320909Q' tipo_acceso = '2' nombre = 'Natalie' apellidos = 'Clark' email = 'PETER.CLARK@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '049573865T' tipo_acceso = '1' nombre = 'Faith' apellidos = 'Black' email = 'DAN.BLACK@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '203947278B' tipo_acceso = '3' nombre = 'Carolyn' apellidos = 'Wright' email = 'ADRIAN.WRIGHT@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '234234231T' tipo_acceso = '5' nombre = 'Penelope' apellidos = 'King' email = 'CAROLINE.KING@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '239482309W' tipo_acceso = '5' nombre = 'Julian' apellidos = 'Underwood' email = 'DAN.UNDERWOOD@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '276594867J' tipo_acceso = '5' nombre = 'Olivia' apellidos = 'Allan' email = 'OWEN.ALLAN@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '283748858A' tipo_acceso = '5' nombre = 'Eric' apellidos = 'Knox' email = 'LILY.KNOX@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '324726345S' tipo_acceso = '4' nombre = 'Vanessa' apellidos = 'Baker' email = 'SUE.BAKER@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '340958439D' tipo_acceso = '5' nombre = 'Michael' apellidos = 'Short' email = 'JASON.SHORT@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '345093450E' tipo_acceso = '3' nombre = 'Sue' apellidos = 'Sanderson' email = 'JOAN.SANDERSON@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '345838534R' tipo_acceso = '5' nombre = 'Lily' apellidos = 'Langdon' email = 'ANDREW.LANGDON@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '348947597P' tipo_acceso = '5' nombre = 'Lillian' apellidos = 'Davies' email = 'JULIAN.DAVIES@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '378458844M' tipo_acceso = '5' nombre = 'Joseph' apellidos = 'Smith' email = 'NATALIE.SMITH@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '423586845G' tipo_acceso = '5' nombre = 'Stephanie' apellidos = 'Quinn' email = 'LILLIAN.QUINN@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '430958433A' tipo_acceso = '2' nombre = 'Joan' apellidos = 'Short' email = 'WENDY.SHORT@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '439853453C' tipo_acceso = '5' nombre = 'Wendy' apellidos = 'Newman' email = 'JOSEPH.NEWMAN@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '453532543O' tipo_acceso = '1' nombre = 'Neil' apellidos = 'Wilson' email = 'VANESSA.WILSON@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '489632882D' tipo_acceso = '5' nombre = 'Sonia' apellidos = 'Welch' email = 'NEIL.WELCH@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' )
    ( id_cliente = '540867547H' tipo_acceso = '5' nombre = 'Adrian' apellidos = 'Young' email = 'PENELOPE.YOUNG@EMAIL.COM' url = 'https://img1.picmix.com/output/stamp/normal/5/7/0/3/1723075_e0eda.png' ) ).

    DELETE FROM ztb_clientes_CG.
    INSERT ztb_clientes_CG FROM TABLE @lt_clientes.
...
**********************************************************************
    ...
    DELETE FROM ztb_clnts_lib_CG.
    INSERT ztb_clnts_lib_CG FROM TABLE @lt_clnts_lib.
...
**********************************************************************
    ...
    DELETE FROM ztb_libros_CG.
    INSERT ztb_libros_CG FROM TABLE @lt_libros.
